...
export const EXTENSION_VERBS = Object.freeze({
  ...
  reorderExternalPearlFunctionMoves: (context) => canonicalPearlAction(context, "reorderPearlFunctionMoves", {
    functionId: context.args.functionId,
    functionName: context.args.functionName,
    fromIndex: context.args.fromIndex,
    toIndex: context.args.toIndex,
    from: context.args.from,
    to: context.args.to,
    move: context.args.move,
    moveName: context.args.moveName,
  }),
  decomposeExternalPearlFunctionMove: (context) => canonicalPearlAction(context, "decomposePearlFunctionMove", {
    functionId: context.args.functionId,
    functionName: context.args.functionName,
    moveIndex: context.args.moveIndex,
    move: context.args.move,
    moveName: context.args.moveName,
    from: context.args.from,
  }),
