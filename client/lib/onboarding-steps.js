...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    instruction: "The upper rail holds **transformations** — executable pipelines. Drag any card onto paper to transform, or into AI to explore.",
  ...
  },
  {
    ...
    instruction: "Tap **+** to describe a new transformation. **Click any card** to edit it; drag ⠿ onto paper to apply.",
  ...
  },
  {
    id: "drag-function",
    phase: "Transformations",
    title: "Drag transformations",
    instruction: "Drag any **transformation** from the rail onto paper (transform selection) or into AI spacetime (expand a node).",
    target: '[data-tour="functions-toolbox"]',
    verifyKind: "event",
  ...
  },
  {
    id: "edit-function",
    phase: "Transformations",
    title: "Program the transformation",
  ...
  },
  {
    id: "lenses",
    phase: "Transformations",
    title: "Versioned transformations",
    instruction: "Transformations support **cognition git** — branch experiments, commit evolves, diff and merge pipelines.",
  ...
  },
  {
    ...
    phase: "Lenses",
    title: "Lenses",
    instruction: "The lower rail holds **lenses** — reusable ways of seeing. Drag highlighted material there, or onto a lens card to merge.",
  ...
  },
  {
    ...
    instruction: "Select any object and tap **◷** to see which transformations were applied — no motion, just the thread.",
    verifyKind: "event",
