...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    instruction:
      "When brain cells are visible, **drag outward from a cell** to branch deeper — expand, research, explore. Release on a strand to grow that thread. Lenses and generators live in the left column; AI only explores what you send across.",
  ...
  },
  {
    ...
    phase: "Lenses",
    title: "Lenses",
    instruction: "The upper rail holds **lenses** — reusable ways of transforming, as executable pipelines. Drag any card onto paper to transform, or into AI to explore.",
  ...
  },
  {
    ...
    phase: "Lenses",
    title: "Create a lens",
    instruction: "Tap **+** to describe a new lens. **Click any card** to edit it; drag ⠿ onto paper to apply.",
  ...
  },
  {
    ...
    phase: "Lenses",
    title: "Drag lenses",
    instruction: "Drag any **lens** from the rail onto paper (transform selection) or into AI spacetime (expand a node).",
    target: '[data-tour="functions-toolbox"]',
    verifyKind: "event",
  ...
  },
  {
    id: "lenses",
    phase: "Lenses",
    title: "Versioned lenses",
    instruction: "Lenses support **cognition git** — branch experiments, commit evolves, diff and merge pipelines. Fork and merge from any card's ⋯ menu.",
  ...
  },
  {
    ...
    instruction: "Select any object and tap **◷** to see which lenses were applied — no motion, just the thread.",
    verifyKind: "event",
