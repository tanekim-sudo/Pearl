...
const RAW_CAPABILITIES = [
  ...
  ["lockLocalPearls", {}, false, ["privacy"], "Lock this profile's local Pearl metadata on this device", "app"],
  ["unlockLocalPearls", {}, false, ["privacy"], "Unlock this profile's local Pearl metadata on this device", "app"],
  ["deleteLocalData", {}, true, ["privacy"], "Delete only this profile's local Pearl metadata after confirmation", "app"],
  ...
  ["deleteExternalLocalData", {}, true, ["extension", "privacy"], "Delete only the current profile's local Pearl metadata and return a local receipt", "extension"],
  ["lockExternalPearls", {}, false, ["extension", "privacy"], "Lock this profile's local Pearl metadata until explicitly unlocked", "extension"],
  ["unlockExternalPearls", {}, false, ["extension", "privacy"], "Unlock this profile's local Pearl metadata on this device", "extension"],
