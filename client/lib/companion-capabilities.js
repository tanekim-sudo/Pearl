...
const RAW_CAPABILITIES = [
  ...
  ["mergeSemanticOrbs", { ids: "array", name: "string?", sceneId: "string" }, false, ["scene"], "Merge semantic orb contexts into a new preserved capsule"],
  ...
  ["wearPearl", { id: "string?", name: "string?", replace: "boolean?" }, false, ["scene", "interface"], "Add a pearl as an orbiting add-on around the mother companion (default white); replace=true swaps the whole orbit"],
  ["removeWornPearl", { id: "string?", name: "string?" }, false, ["scene", "interface"], "Remove one orbiting pearl by id/name, or clear the whole orbit when unspecified"],
  ["listWornPearls", {}, false, ["scene", "interface"], "List pearls currently orbiting the mother companion"],
  ["inspectWornPearl", {}, false, ["scene", "interface"], "Inspect the merged orbiting pearl pack around the mother companion, or confirm companion is bare"],
  ...
  ["wearExternalPearl", { id: "string" }, false, ["extension", "scene", "interface"], "Wear a saved pearl so the extension companion gains its context and functions", "extension"],
  ["removeExternalWornPearl", {}, false, ["extension", "scene", "interface"], "Clear the worn pearl; companion stays available", "extension"],
...
const INTENT_EXAMPLES = {
  ...
  wearExternalPearl: ["put on the research pearl"],
  ...
  wearPearl: ["put on the LP briefings pearl"],
  removeWornPearl: ["take off the pearl"],
  listWornPearls: ["which pearls are orbiting"],
  inspectWornPearl: ["what pearl am I wearing"],
