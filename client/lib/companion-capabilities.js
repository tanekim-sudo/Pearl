...
const RAW_CAPABILITIES = [
  ...
  ["createSemanticOrb", { sceneId: "string?", id: "string?", name: "string?", material: "object?", placement: "object?", orb: "object?", activate: "boolean?" }, false, ["scene", "interface"], "Make and activate a provenance-preserving pearl: a compact semantic capsule representing noticed material or an emerging idea"],
