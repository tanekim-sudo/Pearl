...
const RAW_CAPABILITIES = [
  ...
  ["createSemanticOrb", { sceneId: "string?", id: "string?", name: "string?", material: "object?", placement: "object?", orb: "object?", activate: "boolean?", systemPrompt: "string?", intent: "string?" }, false, ["scene", "interface"], "Make and activate a pearl whose primary field is a system prompt seeded from the user's intent"],
  ...
  ["interpretPearlPrompt", { utterance: "string", id: "string?", name: "string?", sceneId: "string?", apply: "boolean?" }, false, ["scene", "interface"], "Observe→Interpret→Propose→Apply a pearl systemPrompt + Moves/Weights/Lenses change from any natural-language instruction (Cursor-like trail)"],
