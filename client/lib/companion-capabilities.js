...
const RAW_CAPABILITIES = [
  ...
  ["reorderPearlFunctionMoves", { pearlId: "string?", functionId: "string?", functionName: "string?", fromIndex: "number?", toIndex: "number?", from: "string?", to: "string?", move: "string?", moveName: "string?" }, false, ["scene", "function", "move", "interface"], "Reorder Moves inside a pearl Function (same handler as Studio drag)", "app"],
  ["decomposePearlFunctionMove", { pearlId: "string?", functionId: "string?", functionName: "string?", moveIndex: "number?", move: "string?", moveName: "string?", from: "string?" }, false, ["scene", "function", "move", "interface"], "Decompose one Function Move into smaller ordered Moves (same handler as Studio Decompose)", "app"],
