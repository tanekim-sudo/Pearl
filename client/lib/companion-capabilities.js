...
const RAW_CAPABILITIES = [
  ...
  ["editPearlSystemPrompt", { id: "string?", name: "string?", text: "string?", systemPrompt: "string?", instruction: "string?", mode: "replace|append|rewrite?", sceneId: "string?" }, false, ["scene", "interface"], "Edit a pearl's system prompt from natural language — replace, append, or rewrite"],
