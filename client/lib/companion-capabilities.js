...
const RAW_CAPABILITIES = [
  ...
  ["createSemanticOrb", { sceneId: "string", id: "string?", name: "string?", material: "object?", placement: "object?" }, false, ["scene", "interface"], "Create and activate a compact persistent orb representing explicit material or an emerging idea"],
  ...
  ["createExternalSemanticOrb", { id: "string?", name: "string?", material: "object?" }, false, ["extension", "scene"], "Create a compact persistent orb from the current capture or an emerging idea", "extension"],
...
const INTENT_EXAMPLES = {
  ...
  createSemanticOrb: ["make these notes a new orb called Picasso studies"],
