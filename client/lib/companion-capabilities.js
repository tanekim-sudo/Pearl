...
const RAW_CAPABILITIES = [
  ...
  ["wearPearl", { id: "string?", name: "string?" }, false, ["scene", "interface"], "Put on a pearl so the companion gains its full context, lenses, and bound functions (companion works without any pearl)"],
  ["removeWornPearl", {}, false, ["scene", "interface"], "Take off the worn pearl; companion stays available with no pearl pack"],
  ["inspectWornPearl", {}, false, ["scene", "interface"], "Inspect the currently worn pearl capability pack, or confirm companion is bare"],
