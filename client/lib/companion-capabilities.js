...
const RAW_CAPABILITIES = [
  ...
  ["createRolePearl", { sceneId: "string?", role: "string?", firm: "string?", name: "string?", utterance: "string?", openStudio: "boolean?", wear: "boolean?", materializeLibrary: "boolean?", placement: "object?" }, false, ["scene", "move", "function", "lens", "interface"], "Scaffold a real role pearl (investor memo + diligence + investor lens) with Moves→Functions→Lenses, optionally wear it and open Studio"],
  ...
  ["interpretPearlPrompt", { utterance: "string", id: "string?", name: "string?", sceneId: "string?", apply: "boolean?" }, false, ["scene", "interface"], "Observe→Interpret→Propose→Apply a pearl systemPrompt change from any natural-language instruction (Cursor-like trail)"],
  ["bindSemanticOrb", { id: "string", representation: "object" }, false, ["scene"], "Bind a pearl to a Move, Function, Lens, Scene, query, candidate, branch, transcript, or material"],
...
const INTENT_EXAMPLES = {
  ...
  bindSemanticOrb: ["make this pearl represent my investor memo Function"],
