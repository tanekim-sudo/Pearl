...
const RAW_CAPABILITIES = [
  ...
  ["openBeforeAfterCreation", {}, false, ["move", "function", "interface"], "Removed from Pearl shell UI — refuses and directs to Studio Function editing"],
  ...
  ["toggleOrbCursor", { enabled: "boolean?" }, false, ["interface", "scene"], "Make Pearl the literal pointer or restore the native cursor"],
  ["addOrbContext", { items: "array", priority: "number?", group: "string?" }, false, ["interface", "scene"], "Bring explicit material into Pearl working memory without changing its source"],
  ["updateOrbContext", { id: "string", priority: "number?", pinned: "boolean?", group: "string?" }, false, ["interface", "scene"], "Change the priority, pin, or group of an explicit Pearl context item"],
  ["removeOrbContext", { id: "string" }, false, ["interface", "scene"], "Remove one explicit item from Pearl working memory without deleting its source"],
  ["addOrbLens", { lens: "object", strength: "number?" }, false, ["interface", "scene", "lens"], "Apply a Lens as an editable atmosphere around Pearl"],
  ["updateOrbLens", { id: "string", strength: "number?" }, false, ["interface", "scene", "lens"], "Change the strength of an active Pearl Lens atmosphere"],
  ["removeOrbLens", { id: "string" }, false, ["interface", "scene", "lens"], "Remove an active Lens atmosphere without deleting the Lens"],
  ["createSemanticOrb", { sceneId: "string?", id: "string?", name: "string?", material: "object?", placement: "object?", orb: "object?", activate: "boolean?", systemPrompt: "string?", intent: "string?", systemPromptHint: "string?", materialText: "string?", caption: "string?" }, false, ["scene", "interface"], "Make and activate a pearl whose primary field is a system prompt seeded from the user's intent"],
  ["createRolePearl", { sceneId: "string?", role: "string?", firm: "string?", name: "string?", utterance: "string?", openStudio: "boolean?", wear: "boolean?", materializeLibrary: "boolean?", placement: "object?" }, false, ["scene", "move", "function", "lens", "interface"], "Scaffold a real role pearl (investor memo + diligence + investor lens) with Moves→Weights→Lenses, optionally wear it and open Studio"],
  ["activateSemanticOrb", { id: "string?" }, false, ["scene", "interface"], "Open one pearl as the active capsule or return to the Scene shell"],
  ["moveSemanticOrb", { id: "string", placement: "object" }, false, ["scene", "interface"], "Move a pearl without changing what it represents"],
  ["renameSemanticOrb", { id: "string?", fromName: "string?", name: "string", sceneId: "string?" }, false, ["scene", "interface"], "Rename a pearl"],
  ["getPearlSystemPrompt", { id: "string?", name: "string?", sceneId: "string?" }, false, ["scene", "interface"], "Read the system prompt a pearl carries for Companion interpretation"],
  ["setPearlSystemPrompt", { id: "string?", name: "string?", systemPrompt: "string", mode: "replace|append|rewrite?", sceneId: "string?" }, false, ["scene", "interface"], "Replace a pearl's system prompt (the taste/instructions it carries)"],
  ["editPearlSystemPrompt", { id: "string?", name: "string?", text: "string?", systemPrompt: "string?", instruction: "string?", mode: "replace|append|rewrite?", intelligent: "boolean?", sceneId: "string?" }, false, ["scene", "interface"], "Edit a pearl's system prompt from natural language — intelligent harness rewrite when possible, offline merge otherwise"],
  ["interpretPearlPrompt", { utterance: "string", id: "string?", name: "string?", sceneId: "string?", apply: "boolean?", fastPathHint: "object?", _viaHarness: "boolean?" }, false, ["scene", "interface"], "Observe→Interpret→Propose→Apply a pearl systemPrompt + Moves/Weights/Lenses change from any natural-language instruction (Cursor-like trail)"],
  ["comparePearls", { utterance: "string?", leftId: "string?", rightId: "string?", leftName: "string?", rightName: "string?", produceOutput: "boolean?", sceneId: "string?" }, false, ["scene", "interface", "result"], "Compare two pearls' Moves·Weights·Lenses (+ prompt projection) in chat; optionally download PDF/Markdown — never mutates systemPrompt"],
  ["operatePearl", { utterance: "string", id: "string?", name: "string?", sceneId: "string?" }, false, ["scene", "interface"], "Operate on pearls without mutating the brain — summarize layers, ask about a pearl, or hand off compare/export"],
  ["getPearlWeights", { id: "string?", name: "string?", pearlId: "string?" }, false, ["scene", "interface"], "Read the Weights layer — valued factors, judgements, and tradeoff priorities"],
  ["setPearlWeights", { id: "string?", name: "string?", pearlId: "string?", weights: "array?", mode: "replace|set|append?" }, false, ["scene", "interface"], "Replace or set the Weights layer (preferences / judgements)"],
  ["editPearlWeights", { id: "string?", name: "string?", pearlId: "string?", mode: "replace|set|append|update|remove|clear?", weights: "array?", weight: "object?", text: "string?", note: "string?", priority: "number?", nextName: "string?" }, false, ["scene", "interface"], "Edit Weights from natural language — care/prefer/weight-over tradeoffs"],
  ["bindSemanticOrb", { id: "string", representation: "object" }, false, ["scene"], "Bind a pearl to a Move, Lens, Scene, query, candidate, branch, transcript, or material"],
  ["addSemanticOrbContext", { id: "string?", name: "string?", items: "array?", text: "string?", sceneId: "string?" }, false, ["scene"], "Add preserved material to a pearl"],
  ["removeSemanticOrbContext", { id: "string", itemId: "string" }, false, ["scene"], "Remove context from a pearl without deleting the source"],
  ["applySemanticOrbLens", { id: "string", lens: "object", strength: "number?" }, false, ["scene", "lens"], "Apply an editable Lens atmosphere to a pearl"],
  ["removeSemanticOrbLens", { id: "string", lensId: "string" }, false, ["scene", "lens"], "Remove a Lens from a pearl"],
  ["nestSemanticOrb", { childId: "string", parentId: "string" }, false, ["scene"], "Nest one pearl inside another"],
  ["unnestSemanticOrb", { id: "string" }, false, ["scene"], "Move a nested pearl back to the Scene"],
  ...
  ["composeSemanticOrbs", { ids: "array", name: "string?", sceneId: "string" }, false, ["scene"], "Compose pearls in an explicit order"],
  ...
  ["organizePearl", { id: "string?", name: "string?", extraText: "string?", sceneId: "string?" }, false, ["scene", "move", "function", "lens", "interface"], "Organize a pearl's multimodal dump into Moves → Weights → Lenses without summarizing away richness"],
  ...
  ["splitSemanticOrb", { id: "string", sceneId: "string" }, false, ["scene"], "Split a pearl into source-preserving capsules"],
  ["duplicateSemanticOrb", { id: "string", name: "string?" }, false, ["scene"], "Duplicate a pearl with lineage"],
  ...
  ["discoverFormingPearls", { text: "string?", transcript: "object?", maxPearls: "number?", source: "string?", materialize: "boolean?" }, false, ["scene", "function", "lens", "move", "interface"], "Import chats/docs/drafts and discover ≤5 already-forming pearls (re-asked questions, redone prompts, recurring ops/frames) organized Moves→Weights→Lenses"],
  ["inspectPearlMetadata", { id: "string?", name: "string?" }, false, ["scene", "function", "lens", "move", "interface"], "Inspect the metadata harness beneath a pearl (identity, Moves→Weights→Lenses, working set, provenance, edit bounds)"],
  ...
  ["archiveSemanticOrb", { id: "string", archived: "boolean?" }, false, ["scene"], "Archive or restore a pearl without deleting it"],
  ["deleteSemanticOrb", { id: "string" }, true, ["scene"], "Delete one pearl after scoped confirmation"],
  ...
  ["editPearlOutput", { pearlId: "string?", id: "string?", name: "string?", text: "string", append: "boolean?", instruction: "string?", sceneId: "string?" }, false, ["scene", "paper", "ai"], "Edit Pearl output text directly through the companion with a live director path"],
  ...
  ["openScene", {}, false, ["interface", "scene"], "Open the spatial Scene where pearls play (Companion + gauntlet; Studio via pearl)"],
  ["openOutputFrame", {}, false, ["interface", "scene", "paper"], "Open the optional Output Frame writing surface on Scene"],
  ...
  ["toggleExternalOrbCursor", { enabled: "boolean?" }, false, ["extension", "interface"], "Toggle the literal Pearl cursor on the supported external page", "extension"],
  ["createExternalSemanticOrb", { id: "string?", name: "string?", material: "object?", orb: "object?" }, false, ["extension", "scene"], "Make a provenance-preserving pearl from the current page capture or an emerging idea", "extension"],
  ["createExternalRolePearl", { role: "string?", firm: "string?", name: "string?", utterance: "string?", wear: "boolean?", openStudio: "boolean?" }, false, ["extension", "scene", "move", "function", "lens"], "Scaffold an investor/role pearl with memo + diligence + lens in the extension library and gauntlet", "extension"],
  ["openExternalSemanticOrb", { id: "string" }, false, ["extension", "scene"], "Open a saved pearl on the Pearl shelf", "extension"],
  ["addExternalSemanticOrbContext", { id: "string", items: "array?" }, false, ["extension", "scene"], "Add the current capture or explicit material to a saved pearl", "extension"],
  ["removeExternalSemanticOrbContext", { id: "string", contextId: "string" }, false, ["extension", "scene"], "Remove one explicit context item from a saved pearl without deleting its source", "extension"],
  ["applyExternalSemanticOrbLens", { id: "string", lensId: "string", strength: "number?" }, false, ["extension", "scene", "lens"], "Apply a synced Lens to a saved pearl", "extension"],
  ["removeExternalSemanticOrbLens", { id: "string", lensId: "string" }, false, ["extension", "scene", "lens"], "Remove one Lens atmosphere from a saved pearl", "extension"],
  ["renameExternalSemanticOrb", { id: "string", name: "string" }, false, ["extension", "scene"], "Rename a saved pearl", "extension"],
  ["mergeExternalSemanticOrbs", { ids: "array", name: "string?" }, false, ["extension", "scene"], "Merge saved pearl contexts into a new capsule", "extension"],
  ...
  ["reorderExternalPearlFunctionMoves", { pearlId: "string?", functionId: "string?", functionName: "string?", fromIndex: "number?", toIndex: "number?", from: "string?", to: "string?", move: "string?", moveName: "string?" }, false, ["extension", "scene", "function", "move", "interface"], "Reorder Moves inside an extension pearl Function through the canonical domain handler", "extension"],
  ["decomposeExternalPearlFunctionMove", { pearlId: "string?", functionId: "string?", functionName: "string?", moveIndex: "number?", move: "string?", moveName: "string?", from: "string?" }, false, ["extension", "scene", "function", "move", "interface"], "Decompose one extension pearl Function Move into smaller ordered Moves", "extension"],
  ...
  ["duplicateExternalSemanticOrb", { id: "string", name: "string?" }, false, ["extension", "scene"], "Duplicate a saved pearl with independent editable state", "extension"],
  ["splitExternalSemanticOrb", { id: "string" }, false, ["extension", "scene"], "Split a saved pearl into one pearl per context item or child", "extension"],
  ["unnestExternalSemanticOrb", { id: "string" }, false, ["extension", "scene"], "Remove a saved pearl from its parent without deleting either pearl", "extension"],
  ["archiveExternalSemanticOrb", { id: "string", archived: "boolean?" }, false, ["extension", "scene"], "Archive or restore a saved pearl", "extension"],
  ["deleteExternalSemanticOrb", { id: "string" }, true, ["extension", "scene"], "Delete one saved pearl while preserving source material", "extension"],
  ["openExternalSemanticOrbScene", { id: "string" }, false, ["extension", "scene"], "Open the authoritative web Scene to spatially arrange a saved pearl", "extension"],
...
const RESULT_TYPES = {
  ...
  createRolePearl: "role-pearl",
  createExternalRolePearl: "role-pearl",
...
const INTENT_EXAMPLES = {
  ...
  openSettings: ["open settings", "open account and privacy"],
  openEncodeAnything: ["encode anything", "encode this email into a pearl"],
  openPackageRegistry: ["open packages", "show the packages", "browse packages"],
  openExtensionDownload: ["install the extension", "get the extension", "add pearl to chrome"],
  openScene: ["open a new scene", "open scene", "open the scene", "start a new scene"],
  openOutputFrame: ["open output frame", "show the output frame", "open the frame"],
  ...
  addOrbContext: ["bring these selected notes into Pearl working memory"],
  updateOrbContext: ["pin this context item and make it highest priority"],
  removeOrbContext: ["remove this item from Pearl working memory"],
  ...
  createExternalRolePearl: [
    "make me an investor pearl with investment memo and diligence that understands my lens",
  ],
  activateSemanticOrb: ["open the Picasso studies pearl"],
  moveSemanticOrb: ["move the Picasso pearl to the upper left"],
  renameSemanticOrb: ["rename this pearl Visual grammar"],
  getPearlSystemPrompt: ["what's the system prompt for this pearl", "show me this pearl's instructions"],
  setPearlSystemPrompt: ["rewrite the system prompt to be skeptical of TAM claims"],
  editPearlSystemPrompt: [
    "make this pearl about investor memos that are skeptical of TAM",
    "add that I always want a risks section",
    "rewrite the system prompt to critique hand-wavy market sizing",
    "more like Plath",
    "add skepticism about TAM",
  ...
  comparePearls: [
    ...
    "compare my investor pearl vs Buffett · investing",
    "what are the differences between these two pearls",
  ],
  operatePearl: [
    "summarize this pearl's moves weights and lenses",
    "what does this pearl do",
  ],
  getPearlWeights: ["what are this pearl's weights", "which factors does this pearl value"],
  setPearlWeights: ["set weights to honesty over polish and risk over upside"],
  editPearlWeights: [
    "I care more about honesty than polish",
    "weight risk over upside",
    "prefer concrete imagery over abstraction",
  ],
  bindSemanticOrb: ["make this pearl represent my investor memo process"],
  addSemanticOrbContext: ["put these three references into the Picasso pearl"],
  removeSemanticOrbContext: ["remove that draft from this pearl but keep the source"],
  applySemanticOrbLens: ["apply my skeptical Lens to the Picasso pearl"],
  removeSemanticOrbLens: ["remove the skeptical Lens from this pearl"],
  nestSemanticOrb: ["put the color pearl inside the Picasso pearl"],
  unnestSemanticOrb: ["take the color pearl back out"],
  mergeSemanticOrbs: ["merge these three pearls into one"],
  composeSemanticOrbs: ["compose the evidence pearl then the concise writing pearl"],
  ...
  organizePearl: ["organize this pearl", "organize the dump into moves weights and lenses"],
  ...
  splitSemanticOrb: ["split this pearl back into its source ideas"],
  duplicateSemanticOrb: ["duplicate this pearl for a new direction"],
  ...
  reorderPearlFunctionMoves: [
    "put the last move first",
    "move the first move to the end",
    "reorder the moves — put the recommendation first",
  ],
  decomposePearlFunctionMove: [
    "decompose the first move",
    "break that step into smaller moves",
  ],
  ...
  archiveSemanticOrb: ["archive this pearl"],
  deleteSemanticOrb: ["delete only the abandoned pearl"],
  renameExternalSemanticOrb: ["rename the research pearl Visual grammar"],
  removeExternalSemanticOrbContext: ["remove that capture from the research pearl"],
  removeExternalSemanticOrbLens: ["remove the skeptical Lens from the research pearl"],
  ...
  reorderExternalPearlFunctionMoves: ["put the last move first in this function"],
  decomposeExternalPearlFunctionMove: ["decompose the first move in this function"],
  ...
  duplicateExternalSemanticOrb: ["duplicate the research pearl"],
  splitExternalSemanticOrb: ["split the research pearl into its source ideas"],
  unnestExternalSemanticOrb: ["take the color pearl out of its parent"],
  deleteExternalSemanticOrb: ["delete only the abandoned extension pearl"],
