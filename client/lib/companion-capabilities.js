...
const RAW_CAPABILITIES = [
  ...
  ["openBeforeAfterCreation", {}, false, ["lens", "interface"], "Open the real before-and-after lens creation mode"],
  ["setBeforeAfterText", { side: "before|after", text: "string", example: "number?" }, false, ["lens"], "Set before or after text on the active private example"],
  ["attachSelectionToBeforeAfter", { side: "before|after", target: "string?", example: "number?" }, false, ["lens", "paper", "ai"], "Attach a selected app object to a before or after slot"],
  ["addBeforeAfterExample", {}, false, ["lens"], "Add another private before-and-after example"],
  ["removeBeforeAfterExample", { example: "number" }, false, ["lens"], "Remove one private before-and-after example"],
  ["inferBeforeAfterTransformation", {}, false, ["lens"], "Infer an editable reusable lens specification from complete examples"],
  ["chooseBeforeAfterAlternative", { alternative: "number" }, false, ["lens"], "Choose one inferred alternative hypothesis"],
  ["editInferredFunctionSpec", { name: "string?", summary: "string?", operation: "string?" }, false, ["lens"], "Edit the inferred lens specification before use"],
  ["useInferredFunction", {}, false, ["lens", "interface"], "Populate the normal lens editor from the inferred specification"],
  ["saveLearnedFunction", {}, false, ["lens"], "Save the reviewed learned lens through the normal lens save path"],
  ...
  ["inspectFunctionOutput", { op: "string" }, false, ["lens", "interface"], "Inspect a lens output specification"],
  ["editFunctionOutput", { op: "string", semanticType: "string?", machineKind: "string?", description: "string?", instructions: "string?", cardinality: "number?", outputs: "array?" }, false, ["lens"], "Edit the real semantic output contract of a lens"],
  ["editFunctionBranchOutput", { op: "string", branch: "number|string", label: "string?", machineKind: "string?", to: "number?" }, false, ["lens"], "Edit or reorder one stable branch output"],
  ["setFunctionOutputMode", { op: "string", mode: "derived|override" }, false, ["lens"], "Choose derived child outputs or an explicit parent override"],
  ["resetFunctionOutput", { op: "string" }, false, ["lens"], "Reset a lens to its deterministic suggested output"],
  ...
  ["openExternalBeforeAfter", {}, false, ["extension", "lens", "interface"], "Open the compact external before-and-after capture workflow", "extension"],
  ["setExternalBeforeAfterText", { side: "before|after", text: "string" }, false, ["extension", "lens"], "Set text in an external before or after capture slot", "extension"],
  ["inferExternalBeforeAfter", {}, false, ["extension", "lens"], "Infer and sync a lens from the explicit external before-and-after slots", "extension"],
];
...
const RESULT_TYPES = {
  ...
  useInferredFunction: "lens-preview",
  saveLearnedFunction: "lens",
...
const REF_ARG_TYPES = {
  ...
  inspectFunctionOutput: { op: "lens" },
  editFunctionOutput: { op: "lens" },
  editFunctionBranchOutput: { op: "lens" },
  setFunctionOutputMode: { op: "lens" },
  resetFunctionOutput: { op: "lens" },
...
const INTENT_EXAMPLES = {
  ...
  openBeforeAfterCreation: ["make a lens from this before and after"],
  ...
  saveLearnedFunction: ["save this learned lens"],
