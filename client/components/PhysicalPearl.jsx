...
export default function PhysicalPearl({
  ...
  const pearl = useMemo(
    () => normalizePhysicalPearl({ id: `pearl-${reactId}`, variant, state, size, label, decorative, surrounding, animation }),
    [animation, decorative, label, reactId, size, state, surrounding, variant],
  );
  return <span
