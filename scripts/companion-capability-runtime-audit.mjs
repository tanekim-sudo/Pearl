  ...
  localStorage.setItem("lens.scenes.v4", JSON.stringify({
    ...
    scenes: [{
      ...
      semanticOrbs: [{
        ...
        id: "semantic-parent",
        kind: "semantic-orb",
        sceneId: "release-audit",
        name: "Parent orb",
        placement: { x: 160, y: 80, radius: 24 },
        representation: { kind: "grouped-context", refs: ["claim"], label: "Parent orb", snapshot: null },
        workingSet: { context: [{ id: "claim", kind: "text", text: "Claim material" }], lenses: [], selections: [], branches: [], checkpoints: [] },
        parentOrbId: null,
        childOrbIds: [],
        lineage: [],
        provenance: { source: "runtime-audit" },
        archived: false,
      }, {
        version: 1,
        id: "semantic-a",
        kind: "semantic-orb",
        sceneId: "release-audit",
        name: "Runtime semantic orb",
        placement: { x: 20, y: 30, radius: 24 },
        representation: { kind: "empty", refs: [], label: "Runtime semantic orb", snapshot: null },
        workingSet: { context: [{ id: "orb-note", kind: "text", text: "Orb note" }], lenses: [{ id: "generator-a", kind: "lens", name: "Generator A" }], selections: [], branches: [], checkpoints: [] },
        parentOrbId: null,
        childOrbIds: [],
        lineage: [],
        provenance: { source: "runtime-audit" },
...
const argsByName = {
  ...
  createSemanticOrb: { sceneId: "release-audit", id: "semantic-created", name: "Created semantic orb", placement: { x: 260, y: 30 } },
  activateSemanticOrb: { id: "semantic-a" },
  moveSemanticOrb: { id: "semantic-a", placement: { x: 60, y: 70 } },
  renameSemanticOrb: { id: "semantic-a", name: "Renamed semantic orb" },
  bindSemanticOrb: { id: "semantic-a", representation: { kind: "function", refs: ["op-pipeline"], label: "Pipeline Function" } },
  addSemanticOrbContext: { id: "semantic-a", items: [{ id: "orb-note", kind: "text", text: "Orb note" }] },
  removeSemanticOrbContext: { id: "semantic-a", itemId: "orb-note" },
  applySemanticOrbLens: { id: "semantic-a", lens: { id: "generator-a", kind: "lens", name: "Generator A" }, strength: .6 },
  removeSemanticOrbLens: { id: "semantic-a", lensId: "generator-a" },
  nestSemanticOrb: { childId: "semantic-a", parentId: "semantic-parent" },
  unnestSemanticOrb: { id: "semantic-a" },
  mergeSemanticOrbs: { ids: ["semantic-a", "semantic-parent"], name: "Merged runtime orbs", sceneId: "release-audit" },
  composeSemanticOrbs: { ids: ["semantic-a", "semantic-parent"], name: "Composed runtime orbs", sceneId: "release-audit" },
  splitSemanticOrb: { id: "semantic-parent", sceneId: "release-audit" },
  duplicateSemanticOrb: { id: "semantic-a", name: "Semantic copy" },
  archiveSemanticOrb: { id: "semantic-a", archived: true },
  deleteSemanticOrb: { id: "semantic-parent" },
  ...
  reorderPearlFunctionMoves: { pearlId: "runtime-pearl", functionName: "Investment memo", from: "last", to: "first" },
  decomposePearlFunctionMove: { pearlId: "runtime-pearl", functionName: "Investment memo", move: "first" },
  reorderExternalPearlFunctionMoves: { pearlId: "runtime-pearl", from: "last", to: "first" },
  decomposeExternalPearlFunctionMove: { pearlId: "runtime-pearl", move: "first" },
