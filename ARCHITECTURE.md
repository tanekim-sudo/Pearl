...
- `client/components/CompanionOrb.jsx`, `client/orb-visual-tokens.css`, and `client/orb-universe.css` — semantic orb state rendering, restrained motion tokens, accessible static states, and adaptive repository/Stage surfaces.
