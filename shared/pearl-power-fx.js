...
const COMMAND_POWER = Object.freeze({
  ...
  organizePearl: { kind: "fuse" },
  createCounterPearl: { kind: "echo" },
  evaluateWithGauntlet: { kind: "charge" },
  ...
  setPearlSystemPrompt: { kind: "charge" },
  editPearlSystemPrompt: { kind: "charge" },
  interpretPearlPrompt: { kind: "charge" },
  comparePearls: { kind: "filament" },
  operatePearl: { kind: "settle" },
  getPearlSystemPrompt: { kind: "settle" },
