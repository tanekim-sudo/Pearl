...
export const FEATURE_CONTRACTS = Object.freeze([
  ...
  feature("studio.pearl", {
    ...
    commands: ["openPearlStudio", "editPearlEntity", "setPearlStudioRepresentation", "undoPearlEntityEdit", "redoPearlEntityEdit", "browsePearlHistory", "snapshotPearlVersion", "labelPearlVersion", "restorePearlVersion"],
    ui: ["client/components/PearlStudioView.jsx", "client/components/CognitiveLayerStudio.jsx", "extension/src/result/main.js"],
    companion: ["openPearlStudio", "executeUnifiedPearlAction", "browsePearlHistory", "snapshotPearlVersion", "labelPearlVersion", "restorePearlVersion", "editPearlOutput", "revisePearlFromFeedback"],
    extension: ["executeExternalPearlAction", "openExternalPearlStudio", "openExternalResultPearlTab"],
    persistence: ["pearlEntities.v1", "pearlStudioRefs.v1", "one-time profile/tab/origin-bound handoffs"],
    tests: ["shared/pearl-studio.test.js", "shared/pearl-version-history.test.js", "client/lib/pearl-shell.test.js"],
