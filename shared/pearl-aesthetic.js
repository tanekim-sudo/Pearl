...
export const PEARL_AESTHETIC_PRESETS = Object.freeze({
  classic: {
    ...
    colors: {
      ...
      reflectionMid: "#84938d",
      reflectionDark: "#192722",
      specular: "#ffffff",
    },
    material: { nacreIntensity: 0.34, nucleusIntensity: 0.7, gloss: 0.46, contrast: 0.5, warmth: 0.45, saturation: 0.42, brightness: 0.55 },
  },
  celadon: {
    id: "celadon",
    label: "Celadon",
